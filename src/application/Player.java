...
public class Player extends ImageView {
	...
	// arrays for images (0=Down, 1=Left, 2=Right, 3=Up)
	// Change these from 'private final' to 'private static'
	private static Image[] idleFrames = new Image[4];
	private static Image[] bombIdleFrames = new Image[4];
	private static Image[][] walkFrames = new Image[4][3];
	private static Image[][] bombWalkFrames = new Image[4][3];

	// Add a flag to track if we already loaded them
	...
	public Player(double startX, double startY, 
		...
		// Only hit the hard drive to load these PNGs if they haven't been loaded yet!
		if (!imagesLoaded) {
			...
			imagesLoaded = true; // Lock it so it never loads again!
		}
